...
const BackupDoubleCheck = ({ navigation }) => {
    ...
    return (<Wrapper style={{ backgroundColor: colors.white }}>
      ...
      <buttons_1.PrimaryBtn label={LL.BackupDoubleCheck.continue()} onPress={onContinue} btnStyle={{ marginBottom: bottom || 10 }}/>
    </Wrapper>);
};
exports.default = BackupDoubleCheck;
...
const Container = native_1.default.View `
  row-gap: 10px;
`;
//# sourceMappingURL=BackupDoubleCheck.js.map