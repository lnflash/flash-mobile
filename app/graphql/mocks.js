...
const mocks = [
    {
        request: {
            query: generated_1.MobileUpdateDocument,
        },
        result: {
            data: {
                mobileVersions: [
    ...
    {
        request: {
            query: generated_1.MyLnUpdatesDocument,
        },
        result: {
            data: {
                myUpdates: {
    ...
    {
        request: {
            query: generated_1.SendBitcoinDestinationDocument,
        },
        result: {
            data: {
                globals: {
    ...
    {
        request: {
            query: generated_1.DisplayCurrencyDocument,
        },
        result: {
            data: {
                me: {
    ...
    {
        request: {
            query: generated_1.SendBitcoinConfirmationScreenDocument,
        },
        result: {
            data: {
                me: {
    ...
    {
        request: {
            query: generated_1.SendBitcoinDetailsScreenDocument,
        },
        result: {
            data: {
                globals: {
    ...
    {
        request: {
            query: generated_1.LnNoAmountInvoiceCreateDocument,
            variables: {
        ...
        result: {
            data: {
                lnNoAmountInvoiceCreate: {
                    invoice: {
                        paymentRequest: "lnbc1p3lwh3npp5z5wkmy86gcww9u2h8tuekqmfz4pwlpkk4rfst8cm7jwzm8fklldsdqqcqzpuxqyz5vqsp52fv968tprd3dqkuqsq78nw8s0xr9zn7rx686ukq2rfnsdf27pwtq9qyyssqhc7m7d3gfvdsywx956d3u3h45xyf7xurc6yv5qxysspjnhhxstl3wet525ldxn3x6xd0g58nk6wuvwle0fhn5sul396za3qs5ma7zxsqjvklym",
                        paymentHash: "0ab7a842956c260e1270a46d09e964ac15e0623d4f2d8d4b62af5a608f4c5e06",
                        paymentSecret: "8c92e0f1db2374806ec11e8fea3d1513171bee9304dd54e33a4f2c0347b42006",
    ...
    {
        request: {
            query: generated_1.PaymentRequestDocument,
        },
        result: {
            data: {
                globals: {
    ...
    {
        request: {
            query: generated_1.OnChainAddressCurrentDocument,
            variables: {
    ...
    {
        request: {
            query: generated_1.BalanceHeaderDocument,
        },
        result: {
            data: {
                me: {
    ...
    {
        request: {
            query: generated_1.HomeUnauthedDocument,
        },
        result: {
            data: {
                __typename: "Query",
    ...
    {
        request: {
            query: generated_1.HomeAuthedDocument,
        },
        result: {
            data: {
                me: {
                            ...
                            edges: [
                                ...
                                },
                                {
                                    ...
                                    node: {
                                        ...
                                        initiationVia: {
                                            paymentHash: "34f33b2c30907eb324f2f2128221307e93d3686e8ac71f02b6d8d5679a6b1ad8",
                                ...
                                },
                                {
                                    ...
                                    node: {
                                        ...
                                        initiationVia: {
                                            paymentHash: "a01b22efb5eb7d16ecd47d6a66bb03682018a572d7cd0e069d5202913b99f58e",
                                            __typename: "InitiationViaLn",
                                        },
                                        settlementVia: {
                                            counterPartyWalletId: null,
                                ...
                                },
                                {
                                    ...
                                    node: {
                                        ...
                                        initiationVia: {
                                            paymentHash: "58dce20cde9b58b2218bb9a4afe7f213dfc23daa7fc8b478632521646ad8ad20",
                                            __typename: "InitiationViaLn",
                                        },
                                        settlementVia: {
                                            counterPartyWalletId: null,
                                ...
                                },
                                {
                                    ...
                                    node: {
                                        ...
                                        initiationVia: {
                                            paymentHash: "bff4848dc3e20eb1cb265193d2ff53c41b1aca8ddcc21757e41af842a2e35cef",
                                            __typename: "InitiationViaLn",
                                        },
                                        settlementVia: {
                                            counterPartyWalletId: null,
                                ...
                                },
                                {
                                    ...
                                    node: {
                                        ...
                                        initiationVia: {
                                            paymentHash: "17a6c7d5c7d41c16bfcd0df540c52fbd718d9f4b87a5f823cfad57c176ba012c",
                                            __typename: "InitiationViaLn",
                                        },
                                        settlementVia: {
                                            counterPartyWalletId: null,
                                ...
                                },
                                {
                                    ...
                                    node: {
                                        ...
                                        initiationVia: {
                                            paymentHash: "41d8a8701d5c9fac263dbc8a413ebf5409f730e96ca226e0045924c852898e74",
                                            __typename: "InitiationViaLn",
                                        },
                                        settlementVia: {
                                            counterPartyWalletId: null,
                                ...
                                },
                                {
                                    ...
                                    node: {
                                        ...
                                        initiationVia: {
                                            paymentHash: "6d11c30f52d6f56b7ab28f17163bb07355bf483213c917f5d6c78ccb9662ddd9",
                                            __typename: "InitiationViaLn",
                                        },
                                        settlementVia: {
                                            counterPartyWalletId: null,
...
exports.default = [...mocks, ...mocks, ...mocks, ...mocks, ...mocks, ...mocks];
