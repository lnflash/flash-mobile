...
const en: BaseTranslation = {
  ...
  BankAccountsScreen: {
    ...
    localBankAccounts: "Local bank accounts",
    addBankAccount: "Add US bank account",
    ...
    updateDetails: "Edit details",
    addJamaicanAccount: "Add Jamaican bank account",
    removeConfirmTitle: "Remove this account?",
    removeConfirmMessage:
      "{bankName: string} ending {last4: string} will be removed. You can no longer cash out to it.",
    accountRemoved: "Bank account removed",
    addTitle: "Add bank account",
    addSubtitle: "Add a Jamaican bank account to cash out to. It is ready to use right away.",
    editTitle: "Edit bank account",
    editSubtitle: "Changes take effect right away. Your next cash-out uses the new details.",
    currencyLocked:
      "Currency can't be changed here. To use a different currency, add a new account.",
    currencyFixedOnAdd: "Accounts added here are paid out in JMD.",
    chequing: "Chequing",
    savings: "Savings",
    setAsDefaultHint: "Use this account for cash-outs unless you pick another.",
    addAccount: "Add account",
    saveChanges: "Save changes",
    confirmTitle: "Save changes?",
    confirmMessage: "Your next cash-out will go to the new account details.",
    accountAdded: "Bank account added",
    accountUpdated: "Bank account updated",
    bankRequired: "Select your bank from the list",
    banksLoadError: "We couldn't load the list of banks. Check your connection and try again.",
    banksLoadRetry: "Try again",
    branchRequired: "Branch is required",
    accountTypeRequired: "Select Chequing or Savings",
    accountNumberRequired: "Enter a valid account number (digits only)",
    upgradeRequiredTitle: "Finish your account upgrade",
    errorUpgradeRequired:
      "You need to finish upgrading your account before you can add a bank account.",
    errorNotFound: "We couldn't find that bank account. Refresh and try again.",
    errorDuplicateNumber: "You already have a bank account with this number.",
    errorInvalid: "Some of these details aren't valid. Check them and try again.",
    errorTooManyRequests: "Too many attempts. Wait a moment and try again.",
  ...
  AccountUpgrade: {
      ...
      identityDocTitle: "Which ID will you use?",
      identityDocDesc: "Take a photo of a government-issued ID and a selfie. We use them only to confirm it is you.",
      docPassport: "Passport",
      docPassportDesc: "Photo page only",
      docNationalId: "National ID",
      docDriversLicence: "Driver's licence",
      docCardDesc: "Front and back",
      captureFrontTitle: "Front of your ID",
      captureFrontHint: "Line up the card inside the frame and hold still",
      captureBackTitle: "Back of your ID",
      captureBackHint: "Turn the card over and line it up inside the frame",
      ...
      cameraPermissionDesc: "Flash needs the camera to photograph your ID. Allow camera access in Settings to continue.",
      openSettings: "Open Settings",
      reviewTitle: "Check your photos",
      reviewDesc: "Make sure every photo is sharp and all four corners of your ID are visible.",
      reviewFront: "Front",
      reviewBack: "Back",
      reviewSelfie: "Selfie",
      reviewMissing: "Not taken yet",
      confirmContinue: "Confirm and continue",
      confirmSubmit: "Confirm and submit",
      uploadFailed: "One of your photos did not upload. Check your connection and try again.",
      uploadRetry: "Try again",
      address: "Address",
      addressSearch: "Search for your address",
      addressLine1: "Street address",
      addressLine1Placeholder: "12 Hope Road",
      addressLine2: "Apartment, suite or unit",
      addressLine2Placeholder: "Apt 4",
      city: "City or town",
      cityPlaceholder: "Kingston",
      state: "Parish or state",
      statePlaceholder: "St. Andrew",
      postalCode: "Postal code",
      postalCodePlaceholder: "JMAAW01",
      country: "Country",
      countryPlaceholder: "Jamaica",
      addressFieldRequired: "This field is required",
      statusCardTitle: "Your upgrade request",
      statusSubmitted: "Submitted",
      statusSubmittedDesc: "We received your request and are running the first checks.",
      statusUnderReview: "Under review",
      statusUnderReviewDesc: "A member of our team is reviewing your documents.",
      statusMoreInfoNeeded: "More information needed",
      statusMoreInfoNeededDesc: "Please take new photos so we can finish your review.",
      statusApproved: "Approved",
      statusApprovedDesc: "Your upgrade is complete.",
      statusRejected: "Not approved",
      statusRejectedDesc: "We could not approve this request.",
      resubmit: "Resubmit",
      successResubmitted: "Your new photos have been submitted for review"
    }
}
