...
const en: BaseTranslation = {
  ...
  RefundFlow: {
    ...
    approveFee: "Approve to claim this deposit with the fee shown above, or reject to process a refund to an external wallet.",
    enterAddress: "Enter your Bitcoin address to receive the refund",
    selectFee: "Select a network fee for your refund",
    confirmRefund: "Review and confirm your refund",
    processing: "Processing refund...",
    success: "Success!",
    refundSuccess: "Your refund has been broadcast to the Bitcoin network",
  },
  Nostr: {
