...
const en: BaseTranslation = {
  ...
  Cashout: {
    ...
    settlementRate: "Settlement rate: US$1 = {rate: string}",
    estimatedReceive: "You'll receive about {amount: string} in your bank account",
    estimatedReceiveNote: "Final amount is confirmed on the next screen",
    ...
    currency: "Currency",
    noBankAccountFound: "No bank account found. Please add a bank account first.",
    noExternalAccountFound:
      "No external account found. Please add an external account first.",
  },
  BankAccountsScreen: {
    title: "Bank accounts",
    settingsSubtitle: "Receive & withdraw by bank transfer",
    receiveMoney: "RECEIVE MONEY",
    intoFlash: "into Flash",
    withdrawTo: "WITHDRAW TO",
    ...
    verifyIdentityTitle: "Verify identity to unlock",
    ...
    receiveCardHint: "Share these to receive USD bank transfers into Flash Cash.",
  ...
  BridgeAddExternalAccount: {
    ...
    subtitle: "Enter your US bank account details below to link it for withdrawals.",
    bankName: "Bank Name",
    bankNamePlaceholder: "e.g. Bank of America",
    accountOwnerName: "Account Owner Name",
    accountOwnerNamePlaceholder: "Full name on account",
    routingNumber: "Routing Number",
    routingNumberPlaceholder: "9-digit routing",
    accountNumber: "Account Number",
    ...
    addressFieldsError: "Please fill in your address details",
    bankAccountAddedTitle: "Bank Account Added",
    bankAccountAddedMessage:
      "Your {bankName: string} account (ending in {last4: string}) has been linked successfully.",
    continue: "Continue",
  ...
  HomeScreen: {
    ...
    unclaimedDepositsWarning: "⚠️ P​l​e​a​s​e​ ​c​o​m​p​l​e​t​e​ ​o​r​ claim ​a​l​l​ unclaimed deposits ​b​e​f​o​r​e​ ​u​n​i​n​s​t​a​l​l​i​n​g​ ​F​l​a​s​h​ ​o​r​ unclaimed deposits ​w​i​l​l​ ​b​e​ ​l​o​s​t​.",
    ...
    inviteDesc: "Get up to US$5 for inviting friends to Flash",
  ...
  ReceiveScreen: {
    ...
    cantReceiveZeroSats: "You cannot receive a zero sats. Please enter an amount corresponding to 1 or more sats.",
  ...
  SendBitcoinScreen: {
    ...
    onchainMinAmountInvoiceError: "The amount you entered is less than the minimum amount required to send an on-chain transaction {amount: number}. Please consider sending this amount via Lightning!",
		minAmountInvoiceError: "The amount on the invoice is less than minimum amount {amount: string}",
		maxAmountInvoiceError: "The amount on the invoice is greater than maximum amount {amount: string}",
  ...
  TransactionDetailScreen: {
    ...
    noTransaction: "No transaction found with this ID",
    typeOnChain: "OnChain",
    typeLightning: "Lightning",
    typeIntraLedger: "IntraLedger",
  ...
  TransactionLimitsScreen: {
    ...
    editRequest: "Edit Upgrade Request"
  },
  TransactionScreen: {
  ...
  RefundFlow: {
    ...
    refundTitle: "Refund Deposit",
    destinationTitle: "Destination",
    confirmationTitle: "Confirmation",
    pendingTransactions: "Pending Transactions",
    noRefundables: "No unclaimed deposits found",
    view: "View",
    refund: "Refund",
    ...
    refunded: "Refunded",
    pending: "Pending",
    autoClaiming: "This transfer will be claimed automatically",
    approvalRequired: "Approval Required",
    broadcasting: "Broadcasting",
    feeExceeded: "Fee too high",
    claimFailed: "Claim failed",
    automaticClaim: "This deposit will be claimed automatically when network fees are lower.",
    approveFee: "Approve to claim this transfer, or reject to process a refund.",
    enterAddress: "Enter the Bitcoin address where you want to receive the refund.",
    selectFee: "Select a network fee for your refund",
    confirmRefund: "Confirm & Refund",
    processing: "Processing refund...",
    success: "Refund Broadcast",
    refundSuccess: "Your refund has been sent to the Bitcoin network.",
    refundFailed: "Refund Failed",
    failedToClaim: "Failed to claim deposit",
    unknownError: "Unknown error occurred",
    missingUtxo:
      "The deposit UTXO is missing. The transaction may not be confirmed yet.",
    couldNotClaimAutomatically: "This deposit could not be claimed automatically.",
    networkFee: "Network Fee",
    networkFeeWithRate: "Network Fee ({feeRate: string} sat/vB)",
    youReceive: "You Receive",
    approve: "Approve",
    refundToExternalWallet: "You can refund it to an external wallet.",
    enterDestinationAddress: "Please enter a destination address",
    invalidBitcoinAddress: "Invalid Bitcoin address format",
    estimatedFee: "Est. Network Fee ({feeRate: string} sat/vB)",
    estimatedReceive: "Est. You Receive",
    feeEstimateDisclaimer:
