...
const en: BaseTranslation = {
  ...
  AccountUpgrade: {
      ...
      personal: "Personal",
      personalDesc: "For individual use, no additional info needed",
      pro: "Pro",
      proDesc: "Accept payments as a Pro Flashpoint. Business Name & Address required",
      merchant: "Merchant",
      merchantDesc: "Give rewards as a Merchant Flahpoint. ID and Bank account info required",
