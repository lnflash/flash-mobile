...
type PersistentState_8 = {
  ...
  flashcardHtml?: string
  hasPostedToNostr?: boolean // true if user has made at least one Nostr post
  // Boltcard settings - extracted from card LNURL for API calls
  flashcardStoreId?: string // BTCPayServer store ID
  flashcardCardId?: string // Card identifier
  flashcardApiBaseUrl?: string // BTCPayServer base URL for API calls
}
