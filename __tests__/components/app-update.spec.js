...
const app_update_logic_1 = require("@app/components/app-update/app-update.logic");
...
describe("testing isUpdateAvailableOrRequired with normal build number", () => {
    it("outdated should return true", () => {
        ...
        const result = (0, app_update_logic_1.isUpdateAvailableOrRequired)({ buildNumber, mobileVersions, OS });
