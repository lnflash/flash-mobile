...
const earns_utils_1 = require("@app/screens/earns-screen/earns-utils");
...
describe("Earn utils test", () => {
    it("Converts quiz sections to proper types", () => {
        ...
        const quizSectionContent = (0, earns_utils_1.getQuizQuestionsContent)({ LL });
        expect(quizSectionContent).toStrictEqual(expectedEnglishQuizSections);
    });
});
//# sourceMappingURL=earns-utils.test.js.map